        ...
        <div className="max-w-4xl mx-auto text-center space-y-8">
          ...
          <p className="text-lg md:text-xl text-muted-foreground max-w-2xl mx-auto leading-relaxed">
            <span className="font-semibold text-foreground">
              {t("Your daily companion for Islamic learning")}
            </span>{" "}
            {t(
              "SunnahMind blends trustworthy sources, calm design, and structured learning so you can return every day.",
            )}
          </p>
          ...
          {/* Key Features */}
          <div
            className="grid md:grid-cols-3 gap-6 pt-12 max-w-3xl mx-auto animate-fade-in"
          ...
          >
            <div className="p-6 rounded-lg bg-card border border-border/50 shadow-sm hover:shadow-elegant transition-all">
              ...
              <p className="text-sm text-muted-foreground">
                {t(
                  "All answers cite specific hadiths from sunnah.com with clear references",
                )}
              </p>
            </div>
            ...
            <div className="p-6 rounded-lg bg-card border border-border/50 shadow-sm hover:shadow-elegant transition-all">
              ...
              <h3 className="font-semibold mb-2">{t("Adab-First Guidance")}</h3>
              <p className="text-sm text-muted-foreground">
                {t(
                  "We provide references and context, not religious rulings. Consult qualified scholars.",
                )}
              </p>
            </div>
            ...
            <div className="p-6 rounded-lg bg-card border border-border/50 shadow-sm hover:shadow-elegant transition-all">
              ...
              <h3 className="font-semibold mb-2">{t("Structured Learning")}</h3>
              <p className="text-sm text-muted-foreground">
                {t(
                  "Articles, 'Ilm paths, and adhkaar help you build daily consistency.",
                )}
              </p>
            </div>
          </div>
